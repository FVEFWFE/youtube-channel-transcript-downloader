#!/usr/bin/env python3
"""
starter_story_transcript_downloader.py
Download all available transcripts from Starter Story's YouTube channel.
"""
...
CHANNEL_URL: str = "https://www.youtube.com/@starterstory/videos"
OUTPUT_DIR: str = "starter_story_transcripts"
COMBINED_FILE: str = "starter_story_all_transcripts.txt"
...
def main() -> None:
    ...
    with open(COMBINED_FILE, "w", encoding="utf-8") as combined:
        combined.write(f"# Starter Story - Complete YouTube Channel Transcripts\n")
