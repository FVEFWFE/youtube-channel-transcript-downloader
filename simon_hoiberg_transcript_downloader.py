#!/usr/bin/env python3
"""
simon_hoiberg_transcript_downloader.py
Download all available transcripts from Simon Hoiberg's YouTube channel.
"""
...
CHANNEL_URL: str = "https://www.youtube.com/@SimonHoiberg/videos"
OUTPUT_DIR: str = "simon_hoiberg_transcripts"
COMBINED_FILE: str = "simon_hoiberg_all_transcripts.txt"
...
def main() -> None:
    ...
    with open(COMBINED_FILE, "w", encoding="utf-8") as combined:
        combined.write(f"# Simon Hoiberg - Complete YouTube Channel Transcripts\n")
