#!/usr/bin/env python3
"""
marc_lou_transcript_downloader.py
Download all available transcripts from Marc Lou's YouTube channel.
"""
...
CHANNEL_URL: str = "https://www.youtube.com/@marc-lou/videos"
OUTPUT_DIR: str = "marc_lou_transcripts"
COMBINED_FILE: str = "marc_lou_all_transcripts.txt"
...
def main() -> None:
    ...
    with open(COMBINED_FILE, "w", encoding="utf-8") as combined:
        combined.write(f"# Marc Lou - Complete YouTube Channel Transcripts\n")
